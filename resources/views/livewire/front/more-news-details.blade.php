                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white border border-top-0 p-3">
                            ...
                            <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                                <img class="img-fluid" src="{{ asset('storage/news/photo/'.$section->photo)}}" alt=""  style="width:100px;width:120px;">
                                <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                    <div class="mb-2">
                                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href="#">{{ $section->category->category }}</a>
                                        <a class="text-body" href="#"><small>{{ $section->created_at->format('l d F') }}</small></a>
                                    </div>
                                    <a class="h6 m-0 text-secondary text-lowercase font-weight-bold" href="#">{{ $section->title }}</a>
                                </div>
                            </div>
                            @endforeach
                        </div>
