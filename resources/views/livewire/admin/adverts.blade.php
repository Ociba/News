        ...
        <div class="card-header border-0">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                ...
                <div class="d-flex flex-row" style="width: 100%; max-width: 300px;">
                    ...
                    <a href="#" class="btn  btn-neutral w-100" onclick="Livewire.dispatch('openModal', { component: 'admin.forms.add-advert' })">Add Advert</a>
                </div>
            ...
            <div class="card-body p-0">
                ...
                <table class="table align-items-center table-flush">
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            <td>{{$i + 1}}</td>
                            <td scope="row" class="text-capitalize">{{$advert->section->section_name}}</td>
                            <td><img src="{{ asset('storage/adverts/'.$advert->image)}}" style="width:50px;  height:40px;"></td>
                            <td scope="row">{{$advert->start_date->format('Y-m-d')}}</td>
                            <td scope="row">{{$advert->end_date->format('Y-m-d')}}</td>
                            <td scope="row">{{$advert->advert_status}}</td>
                            <td class="budget">{{$advert->user->name}}</td>
                            <td class="">
