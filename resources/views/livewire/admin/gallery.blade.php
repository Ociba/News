        ...
        <div class="card-header border-0">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                ...
                <div class="d-flex flex-row" style="width: 100%; max-width: 300px;">
                    ...
                    <a href="#" class="btn  btn-neutral w-100" onclick="Livewire.dispatch('openModal', { component: 'admin.create-gallery' })">Add Gallery</a>
                </div>
        ...
        <div class="table-responsive">
                ...
                <table class="table align-items-center table-flush">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th scope="col" class="sort" data-sort="name">Heading</th>
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            <td>{{$i + 1}}</td>
                            <td scope="row" class="text-capitalize">{{$gallery->heading}}</td>
                            <td scope="row"><img src="{{ asset('storage/gallery/'.$gallery->image)}}" style="width:60px;height:50px;"></td>
                            <td class="budget">{{$gallery->creator->name}}</td>
                            <td class="">
            ...
            <div class="card-footer py-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                    ...
                    <div>
                        {{ $galleries->links('vendor.livewire.pagination.bootstrap') }}
                    </div>
                </div>
            </div>
        </div>
