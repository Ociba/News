                ...
                <div class="bg-white border border-top-0 p-4">
                    <div class="mb-2">
                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                            href="">{{ $latest->category->category }}</a>
                        <a class="text-body" href=""><small>{{ $latest->created_at->format('l d F, Y ') }}</small></a>
                    </div>
                    <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="">{{ Str::limit($latest->title,25) }}</a>
